...
<!-- Login Form -->
<div class="container">
  <form class="login-box" onsubmit="event.preventDefault(); alert('Login simulated inside Streamlit. Integrate backend for real logic.')">
    <h2>Welcome Back</h2>
...
""", height=700, width=800, scrolling=False)
